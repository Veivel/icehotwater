...
switch(testType){
  ...
  case'smoke':options.stages=[{duration:'10s',target:5},{duration:'20s',target:5},{duration:'10s',target:0}];
  break;

  case'average':options.stages=[{duration:'1m',target:20},{duration:'3m',target:20},{duration:'30s',target:0}];
  break;
